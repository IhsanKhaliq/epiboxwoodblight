...
This analysis is packaged and fully reproducible. All data from this work are included in this repository in the "inst/extdata" folder. Code used for importing data, data munging, visualisation and model fitting are available to run in R Markdown vignettes, including extra instruction for which we did not have space in the paper.  A user-friendly website for the research compendium is available here <https://ihsankhaliq.github.io/epiboxwoodblight/>. The vignettes can also be accessed under the "Articles" menu item of the [website](https://ihsankhaliq.github.io/epiboxwoodblight/)
