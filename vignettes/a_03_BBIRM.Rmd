...
lws_plots <- (Lws_1 +Lws_2)/ (Lws_3+ Lws_4) + 
  ...
  # lws_plots <- annotate_figure(lws_plots, left = textGrob("Number of infected leaves", rot = 90, vjust = 1), bottom = textGrob("")) 
...
fig_index_lesions <- wrap_plots(lws_plots, Nlws_plots, rs_plots)
  ...
  ggsave(
    here("man", "figures/fig_index_lesions.svg"),
